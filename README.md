...
**수정 필요 항목**
```cpp
const float CAPACITY_AH = 2.5;   // 실제 셀 용량으로 변경
...
const double CAPACITY_AH = 2.5;     // 실제 셀 용량으로 변경
